...
minionTable = {
    ['x'] = {274, 274, 274; n=amountOfInstances},
    ['y'] = {500, 500, 500; n=amountOfInstances}
}
...
function onUpdate(elapsed)
    if getProperty('TalkNorm.animation.curAnim.finished') == true and getProperty('TalkNorm.animation.curAnim.name') == '1' then
        setProperty('TalkNorm.visible', false);
