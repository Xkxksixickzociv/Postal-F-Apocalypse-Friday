...
local xx = 1000; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local yy2 = 880; -- Same code as above, but for boyfriend up, down
local xx3 = 1200; -- Same code as above, but for girlfriend left, right
local yy3 = 880; -- Same code as above, but for girlfriend, up, down
